...
> This simple project bulit with HTML and CSS
...
- **[Display only Hello Microverse with crimson color]**
...
git clone git@github.com:mulugithub/Hello-Microverse.git

### Usage

To run the project, open the project using a live server from any code editor.
